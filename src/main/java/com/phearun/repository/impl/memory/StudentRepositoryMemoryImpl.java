package com.phearun.repository.impl.memory;
...
public class StudentRepositoryMemoryImpl implements StudentRepository{
	...
	public StudentRepositoryMemoryImpl() {
		 ...
		 for(int i=0; i<10; i++){
			students.add(new Student(i, "fn" + i, "ln"+i, i/2==0?"M":"F", true, new Timestamp(new Date().getTime()), "PP", "012 222 34" + i, "/resources/admin/images/user.png"));
		 }
	}
